...
class BoardStateTest {
    ...
    void testMove1(){
        ...
        boardState.move(new Move(ChessPieceConstants.PIECE_INT_MAPPING.get('N'), 6, 21, 0));
    ...
    void testMove2(){
        ...
        boardState.move(new Move(ChessPieceConstants.PIECE_INT_MAPPING.get('P'), 11, 19, 0));
    ...
    void testMove3(){
        ...
        boardState.move(new Move(ChessPieceConstants.PIECE_INT_MAPPING.get('P'), 11, 27, 1));
    ...
    void testMove4(){
        ...
        boardState.move(new Move(ChessPieceConstants.PIECE_INT_MAPPING.get('R'), 7, 6, 0));
    ...
    void testMove5(){
        ...
        boardState.move(new Move(ChessPieceConstants.PIECE_INT_MAPPING.get('R'), 0, 1, 0));
    ...
    void testMove6(){
        ...
        boardState.move(new Move(ChessPieceConstants.PIECE_INT_MAPPING.get('K'), 4, 11, 0));
    ...
    void testMove7(){
        ...
        boardState.move(new Move(ChessPieceConstants.PIECE_INT_MAPPING.get('r'), 63, 62, 0));
    ...
    void testMove8(){
        ...
        boardState.move(new Move(ChessPieceConstants.PIECE_INT_MAPPING.get('r'), 56, 57, 0));
    ...
    void testMove9(){
        ...
        boardState.move(new Move(ChessPieceConstants.PIECE_INT_MAPPING.get('k'), 60, 51, 0));
    ...
    void testMove10(){
        ...
        boardState.move(new Move(ChessPieceConstants.PIECE_INT_MAPPING.get('K'), 4, 6, 2));
    ...
    void testMove11(){
        ...
        boardState.move(new Move(ChessPieceConstants.PIECE_INT_MAPPING.get('K'), 4, 2, 3));
    ...
    void testMove12(){
        ...
        boardState.move(new Move(ChessPieceConstants.PIECE_INT_MAPPING.get('k'), 60, 62, 2));
    ...
    void testMove13(){
        ...
        boardState.move(new Move(ChessPieceConstants.PIECE_INT_MAPPING.get('k'), 60, 58, 3));
    ...
    void testMove14(){
        ...
        boardState.move(new Move(ChessPieceConstants.PIECE_INT_MAPPING.get('P'), 27, 36, 4));
    ...
    void testMove15(){
        ...
        boardState.move(new Move(ChessPieceConstants.PIECE_INT_MAPPING.get('N'), 30, 45, 4));
    ...
    void testMove16(){
        ...
        boardState.move(new Move(ChessPieceConstants.PIECE_INT_MAPPING.get('p'), 36, 27, 4));
    ...
    void testMove17(){
        ...
        boardState.move(new Move(ChessPieceConstants.PIECE_INT_MAPPING.get('b'), 52, 38, 4));
    ...
    void testMove19(){
        ...
        boardState.move(new Move(ChessPieceConstants.PIECE_INT_MAPPING.get('P'), 35, 44, 5));
    ...
    void testMove20(){
        ...
        boardState.move(new Move(ChessPieceConstants.PIECE_INT_MAPPING.get('P'), 37, 44, 5));
    ...
    void testMove21(){
        ...
        boardState.move(new Move(ChessPieceConstants.PIECE_INT_MAPPING.get('p'), 27, 20, 5));
    ...
    void testMove22(){
        ...
        boardState.move(new Move(ChessPieceConstants.PIECE_INT_MAPPING.get('p'), 28, 19, 5));
    ...
    void testMove23(){
        ...
        boardState.move(new Move(ChessPieceConstants.PIECE_INT_MAPPING.get('P'), 54, 62, 8));
    ...
    void testMove24(){
        ...
        boardState.move(new Move(ChessPieceConstants.PIECE_INT_MAPPING.get('P'), 54, 62, 9));
    ...
    void testMove25(){
        ...
        boardState.move(new Move(ChessPieceConstants.PIECE_INT_MAPPING.get('P'), 54, 62, 10));
    ...
    void testMove26(){
        ...
        boardState.move(new Move(ChessPieceConstants.PIECE_INT_MAPPING.get('P'), 54, 62, 11));
    ...
    void testMove27(){
        ...
        boardState.move(new Move(ChessPieceConstants.PIECE_INT_MAPPING.get('P'), 54, 63, 12));
    ...
    void testMove28(){
        ...
        boardState.move(new Move(ChessPieceConstants.PIECE_INT_MAPPING.get('P'), 54, 63, 13));
    ...
    void testMove29(){
        ...
        boardState.move(new Move(ChessPieceConstants.PIECE_INT_MAPPING.get('P'), 54, 63, 14));
    ...
    void testMove30(){
        ...
        boardState.move(new Move(ChessPieceConstants.PIECE_INT_MAPPING.get('P'), 54, 63, 15));
