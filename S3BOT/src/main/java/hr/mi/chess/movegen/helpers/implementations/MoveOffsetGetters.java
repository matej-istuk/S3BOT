...
public class MoveOffsetGetters {
    public static final MoveOffsetGetter PUSH_GETTER = ChessPiece::getMoveOffsets;
    public static final MoveOffsetGetter CAPTURE_GETTER = ChessPiece::getAttackOffsets;
}
